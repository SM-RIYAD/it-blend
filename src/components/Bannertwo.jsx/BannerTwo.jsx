const BannerTwo = () => {
    return (
      <div className="carousel w-full">
        <div
          id="slide1"
          className="carousel-item h-[800px] bg-gradient-to-r from-cyan-500 to-emerald-500  relative w-full"
        >
          <img
          ...
          <div className="absolute lg:flex-row flex-col flex  border  w-full h-full    justify-center lg:gap-10  lg:p-32 p-5 ">
            ...
            <div>
              ...
              <img
                className="ps-[100px] w-2/3 xl:block lg:hidden hidden xl:scale-150 lg:scale-110 bg-cover"
