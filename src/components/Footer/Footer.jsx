...
const Footer = () => {
    return (
        <div>
            <footer className="footer   mt-10 p-10 bg-base-200 text-blue-400">
   ...
   {/* <img
              ...
              /> */}
              <h1 className='text-blue-400 text-5xl font-bold'>
                IT BLEND
              </h1>
  ...
  <nav>
    ...
    <a className="link link-hover">Backend Solution</a>
  </nav> 
  <nav>
